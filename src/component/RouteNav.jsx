        ...
        return (
            <div className="flex">
                <div className="w-full h-1/2 mt-5 flex justify-center items-center gap-4 font-bold bg-blue-500 rounded-md p-3 ">
                    ...
                    <Link to="/boxoffice" className="hover:cursor-pointer hover:text-gray-300">일일박스오피스</Link>
                    <Link to="/gallery" className="hover:cursor-pointer hover:text-gray-300">관광정보갤러리</Link>
                    <button onClick={handleClick} className="hover:cursor-pointer hover:text-gray-300">부산축제정보</button>
                    <Link to="/chargeInfo" className="hover:cursor-pointer hover:text-gray-300">전기차충전소정보</Link>
                    <Link to="/todolist" className="hover:cursor-pointer hover:text-gray-300">할일목록</Link>
                    <Link to="/subway" className="hover:cursor-pointer hover:text-gray-300">지하철실내공기질</Link>
                </div>
